...
export class AuthorityHistoryPairFactory__factory extends ContractFactory {
  ...
  override getDeployTransaction(
    _authorityFactory: AddressLike,
    _historyFactory: AddressLike,
  ...
  override connect(
    ...
    return super.connect(runner) as AuthorityHistoryPairFactory__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AuthorityHistoryPairFactoryInterface {
    return new Interface(_abi) as AuthorityHistoryPairFactoryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AuthorityHistoryPairFactory;
  }
}
