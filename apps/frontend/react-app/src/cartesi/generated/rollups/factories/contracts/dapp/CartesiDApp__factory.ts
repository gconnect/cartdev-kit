...
export class CartesiDApp__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): CartesiDApp__factory {
    return super.connect(runner) as CartesiDApp__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CartesiDAppInterface {
    return new Interface(_abi) as CartesiDAppInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): CartesiDApp {
    return new Contract(address, _abi, runner) as unknown as CartesiDApp;
  }
}
