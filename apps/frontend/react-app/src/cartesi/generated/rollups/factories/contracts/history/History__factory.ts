...
export class History__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): History__factory {
    return super.connect(runner) as History__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): HistoryInterface {
    return new Interface(_abi) as HistoryInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): History {
    return new Contract(address, _abi, runner) as unknown as History;
  }
}
